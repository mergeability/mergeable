...
class Project extends Validator {
  ...
  async validate (context, validationSettings) {
    ...
    const MATCH_NOT_FOUND_ERROR = `Failed to run the test because 'regex' is not provided for 'project' option. Please check README for more information about configuration`
    ...
    if (!projectName) {
      return constructError('project', projects, validationSettings, MATCH_NOT_FOUND_ERROR)
    }
    ...
    return consolidateResult([constructOutput('project', projects, validationSettings, {
