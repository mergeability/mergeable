...
const DEFAULT_FAIL_AUTHOR_EMAIL_MESSAGE = 'Some or all of your author emails doesn\'t meet the criteria'
const DEFAULT_FAIL_COMMITTER_EMAIL_MESSAGE = 'Some or all of your committer emails doesn\'t meet the criteria'
  ...
  async validate (context, validationSettings) {
    ...
    const result = await mustInclude.process(validatorContext, commitMessages, {
      must_include: {
        ...
        message: messageSettings.message ? messageSettings.message : FAIL_MESSAGE
      }
    })
