...
| September 22, 2020 : Allow support for customizing the scheduler interval via an enviroment variable `MERGEABLE_SCHEDULER_INTERVAL` `#384 <https://github.com/mergeability/mergeable/issues/384>`_
